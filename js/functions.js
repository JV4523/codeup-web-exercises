...
let total = parseFloat(prompt("What is your total Bill?"));
let tip = parseFloat(prompt("What percentage would you like to tip your server?  \nPlease use decimal format."));
...
let price = parseFloat(prompt("What is your total price?"));
let discount = parseFloat(prompt("What is the discount percentage? \nPlease use decimal format."));
alert ("You total price is " + "$" + (applyDiscount(price, discount)))