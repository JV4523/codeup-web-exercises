...
alert(`User worked for Amazon for ${aHours} hours this week at a rate of ${aRate.toFixed(2)} per hour. \n\n User is paid: ${(aHours * aRate).toFixed(2)}`);
...
alert(`User worked for Meta for ${mHours} hours this week at a rate of ${mRate.toFixed(2)} per hour. \n\n User is paid: ${(mHours * mRate).toFixed(2)}`);
...
alert(`User's final take home pay is: ${fPay.toFixed(2)}`);